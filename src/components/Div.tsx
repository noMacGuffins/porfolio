...
const propsToClx = (props) => {
  ...
  const map = {
		...
		bgGray800: () => clxs.push("bg-gray-800"),
		bgGray900: () => clxs.push("bg-gray-900"),
		bgGrayOpacity: () => clxs.push("bg-grayOpacity"),
		bgGrayOpacity100: () => clxs.push("bg-grayOpacity-100"),
		bgGrayOpacity200: () => clxs.push("bg-grayOpacity-200"),
		bgGrayOpacity300: () => clxs.push("bg-grayOpacity-300"),
		bgGrayOpacity400: () => clxs.push("bg-grayOpacity-400"),
		bgGrayOpacity500: () => clxs.push("bg-grayOpacity-500"),
		bgGrayOpacity600: () => clxs.push("bg-grayOpacity-600"),
		bgGrayOpacity700: () => clxs.push("bg-grayOpacity-700"),
		bgGrayOpacity800: () => clxs.push("bg-grayOpacity-800"),
		bgGrayOpacity900: () => clxs.push("bg-grayOpacity-900"),
		...
		// div blur
		blurSm: () => clxs.push("blur-sm"),
		blur: () => clxs.push("blur"),
		blurMd: () => clxs.push("blur-md"),
		blurLg: () => clxs.push("blur-lg"),
		blurXl: () => clxs.push("blur-xl"),
		blur2xl: () => clxs.push("blur-2xl"),
		blur3xl: () => clxs.push("blur-3xl"),
		// backdrop blur
