...
//   if (obj) {
//     const list = classNames(obj).split(' ').map(clx => {
...
const propsToClx = (props) => {
  ...
  const map = {
    ...
    col: () => clxs.push('col'),
    col1: () => clxs.push('col-1'),
    col2: () => clxs.push('col-2'),
    col3: () => clxs.push('col-3'),
    col4: () => clxs.push('col-4'),
    col5: () => clxs.push('col-5'),
    col6: () => clxs.push('col-6'),
    col7: () => clxs.push('col-7'),
    col8: () => clxs.push('col-8'),
    col9: () => clxs.push('col-9'),
    col10: () => clxs.push('col-10'),
    col11: () => clxs.push('col-11'),
    col12: () => clxs.push('col-12'),
    ...
    color: (v) => addStyle(styles, v, { color: v }),
    // //text opacity
    ...
    // //font-family
    fontFamily: (v) => addStyle(styles, v, { fontFamily: v }),
    ...
    // font-weight
    fontItalic: () => clxs.push('font-italic'),
    fontLight: () => clxs.push('font-weight-light'),
    fontNormal: () => clxs.push('font-weight-normal'),
    fontBold: () => clxs.push('font-weight-bold'),
    ...
    // // letter-spacing
    letterSpacing: (v) => addStyle(styles, v, { letterSpacing: pixelOrValue(v) }),
    ...
    borderWidth: (v) => addStyle(styles, v, { borderWidth: pixelOrValue(v) }),
    ...
    // // ==== Box Alignment ====
    // justify-content
    justifyStart: () => clxs.push('justify-content-start'),
    justifyEnd: () => clxs.push('justify-content-end'),
    justifyCenter: () => clxs.push('justify-content-center'),
    justifyBetween: () => clxs.push('justify-content-between'),
    justifyAround: () => clxs.push('justify-content-around'),
    justifyEvenly: () => clxs.push('justify-content-evenly'),
    // // justify-items
    ...
    // align-items
    itemsStretch: () => clxs.push('align-items-stretch'),
    itemsStart: () => clxs.push('align-items-start'),
    itemsCenter: () => clxs.push('align-items-center'),
    itemsEnd: () => clxs.push('align-items-end'),
    itemsBaseline: () => clxs.push('align-items-baseline'),
    // // align-self
    ...
    bgColor: (v) => addStyle(styles, v, { backgroundColor: pixelOrValue(v) }),
    // // background opacity
  ...
  for (const key in props) {
    ...
    if (_.startsWith(key, 'm')) {
      ...
      if (addByPrefix(props, styles, key, 'minW', n => ({ maxWidth: n }))) continue
      if (addByPrefix(props, styles, key, 'minH', n => ({ maxHeight: n }))) continue
    }
    ...
    if (_.startsWith(key, 'rounded')) {
      ...
      if (addByPrefix(props, styles, key, 'roundedT', n => ({
        borderTopLeftRadius: n,
        borderTopRightRadius: n,
      }))) continue
      if (addByPrefix(props, styles, key, 'roundedB', n => ({
        borderBottomLeftRadius: n,
        borderBottomRightRadius: n,
      }))) continue
      if (addByPrefix(props, styles, key, 'roundedL', n => ({
        borderTopLeftRadius: n,
        borderBottomLeftRadius: n,
      }))) continue
      if (addByPrefix(props, styles, key, 'roundedR', n => ({
        borderTopRightRadius: n,
        borderBottomRightRadius: n,
      }))) continue
...
const Div: React.ComponentType<DivPropType> = React.forwardRef((props: DivPropType, ref: any) => {
  const {
    tag,
    h1Tag,
    h2Tag,
  ...
  if (htmlTag == 'h1') return <h1 {...(ref && {ref})} {...propsToPass}>{children}</h1>
  if (htmlTag == 'h2') return <h2 {...(ref && {ref})} {...propsToPass}>{children}</h2>
  if (htmlTag == 'h3') return <h3 {...(ref && {ref})} {...propsToPass}>{children}</h3>
  if (htmlTag == 'h4') return <h4 {...(ref && {ref})} {...propsToPass}>{children}</h4>
  if (htmlTag == 'h5') return <h5 {...(ref && {ref})} {...propsToPass}>{children}</h5>
  if (htmlTag == 'p') return <p {...(ref && {ref})} {...propsToPass}>{children}</p>
  if (htmlTag == 'ul') return <ul {...(ref && {ref})} {...propsToPass}>{children}</ul>
  if (htmlTag == 'li') return <li {...(ref && {ref})} {...propsToPass}>{children}</li>
  if (htmlTag == 'span') return <span {...(ref && {ref})} {...propsToPass}>{children}</span>
  if (htmlTag == 'section') return <section {...(ref && {ref})} {...propsToPass}>{children}</section>
  if (htmlTag == 'footer') return <footer {...(ref && {ref})} {...propsToPass}>{children}</footer>
  if (htmlTag == 'a') return <a {...(ref && {ref})} {...propsToPass}>{children}</a>
  // if (htmlTag == 'img') return <img {...(ref && {ref})} {...propsToPass} />
  if (htmlTag == 'hr') return <hr {...(ref && {ref})} {...propsToPass} />
  if (htmlTag == 'button') return <button {...(ref && {ref})} {...propsToPass}>{children}</button>
  return <div {...(ref && {ref})} {...propsToPass}>{children}</div>
})
Div.displayName = 'Div';
