...
import pic21 from 'public/images/21.png'
...
const MobileFriendlyNav = ({ callBack }) => {
	...
	return (
		<Navbar
			...
			bg="light"
			expand="lg"
			style={{ color: "black", fontFamily: "Bungee Inline", zIndex: 100, padding: size.width > 1000 ? "1vw 20vw 1vw 20vw" : "1vw 5vw 1vw 5vw" }}
			ref={navbarRef}
		>
			<Container fluid>
				<Div mr5>
					<Logo fill={"black"} width={50} height={50}></Logo>
				</Div>
				{size.width && size.width > 400 && <Navbar.Brand href="#home">BearDom</Navbar.Brand>}
				<Navbar.Toggle aria-controls="basic-navbar-nav" />
				<Navbar.Collapse id="basic-navbar-nav">
					<Nav className="me-auto">
						<Nav.Link href="#about" onClick={() => callBack(0)}>
							<Div textCenter>About</Div>
						</Nav.Link>
						<Nav.Link href="#rarity" onClick={() => callBack(1)}>
							<Div textCenter>Rarity</Div>
						</Nav.Link>
						<Nav.Link href="#reroll" onClick={() => callBack(2)}>
							<Div textCenter>Re-Roll</Div>
						</Nav.Link>
						<Nav.Link href="#carp" onClick={() => callBack(3)}>
							<Div textCenter>C.A.R.P</Div>
						</Nav.Link>
						<Nav.Link href="#team" onClick={() => callBack(4)}>
							<Div textCenter>Team</Div>
						</Nav.Link>
						<Nav.Link href="#faq" onClick={() => callBack(5)}>
							<Div textCenter>FAQ</Div>
						</Nav.Link>
					</Nav>
					<Nav>
						<Nav.Link>
							<Row flexNowrap>
								...
								<Col
									...
									onClick={() => {
										window.open("https://discord.gg/P8sTq8y7");
									}}
								>
								...
								<Col
									...
									style={{ cursor: "pointer" }}
									onClick={() => {
										window.open("https://twitter.com/beardom_io");
									}}
								>
...
const DummyNav = () => {
	...
	return (
		<Navbar
			expand="lg"
			style={{ color: "black", fontFamily: "Bungee Inline", zIndex: 0, padding: size.width > 1000 ? "1vw 20vw 1vw 20vw" : "1vw 5vw 1vw 5vw" }}
		>
			<Container fluid>
				<Div mr5>
					<Logo fill={"black"} width={50} height={50}></Logo>
				...
				<Navbar.Collapse id="basic-navbar-nav">
					<Nav className="me-auto">
						...
						<Nav.Link href="#rarity">
							<Div textCenter>Rarity</Div>
						</Nav.Link>
						<Nav.Link href="#reroll">
							<Div textCenter>Re-Roll</Div>
						</Nav.Link>
						<Nav.Link href="#carp">
							<Div textCenter>C.A.R.P</Div>
...
const BottomMenu = ({ callBack }) => {
	return (
		<Div bg={"#232323"} color={"white"} fontFamily={"Bungee Inline"} px={"20%"} py50>
			<Row>
				<Col flex itemsCenter justifyCenter mb10>
					<Logo></Logo>
				</Col>
				...
				<Col mb10>
					<Row>
						<Div textCenter fontSize24 color={"#8294a6"}>
							Menu
						</Div>
					</Row>
					<Row flex itemsCenter justifyCenter>
						<Col>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(0)}>
								About
							</Div>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(1)}>
								Rarity
							</Div>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(2)}>
								Re-Roll
							</Div>
						</Col>
						<Col>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(3)}>
								C.A.R.P.
							</Div>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(4)}>
								Team
							</Div>
							<Div textCenter py10 style={{ cursor: "pointer" }} onClick={() => callBack(5)}>
								FAQ
							</Div>
						</Col>
					</Row>
...
const Home: NextPage = () => {
	...
	const scrollToRef = (index) => {
		window.scrollTo(0, refs[index].current.offsetTop - 130);
	};
	...
	const valuesArr = [
		{
			explanation:
				"Every Bear's metadata is generated on-mint with instant reveal. Nobody has any control over any bear's rarity--randomization truly decentralized.",
			component: (
				<Div py10>
					A{" "}
					<Div spanTag color={"#ffd000"}>
						True Dapp
					</Div>
				</Div>
			),
		...
		{
			explanation:
				"The essence of smart contracts is to ensure promises are fulfilled. Our roadmap offerings are coded into the genesis smart contract fully on-chain.",
			component: (
				<Div py10>
					Conventional roadmaps covering{" "}
					<Div spanTag color={"#ffd000"}>
						Rugpulls
					</Div>
				</Div>
		...
		},
		{
			...
			component: (
				<Div py10>
					hyper-optimized smart contracts for YOUR{" "}
					<Div spanTag color={"#ffd000"}>
						gas money
					</Div>
				</Div>
	...
	const FadeUpDiv = useCallback((props) => {
		return (
			<div
				data-aos="fade-up"
				data-aos-offset="100"
	...
	const ZoomInDiv = useCallback((props) => {
		return <div data-aos="zoom-in">{props.children}</div>;
	}, []);
	...
	const getRandomInt = () => {
		return Math.floor(Math.random() * (bearArray.length - 1));
	};

	const [imagesRow1, setImagesRow1] = useState(Array(12).fill("rgb(248,249,250)"));
	const [imagesRow2a, setImagesRow2a] = useState(Array(3).fill("rgb(248,249,250)"));
	const [imagesRow2b, setImagesRow2b] = useState(Array(7).fill("rgb(248,249,250)"));
	const [imagesRow3, setImagesRow3] = useState(Array(12).fill("rgb(248,249,250)"));
